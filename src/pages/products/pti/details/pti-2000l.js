              ...
              <Box display="flex" justifyContent="space-between">
                <Box>
                  <Typography
                    ...
                    color="#0c248c"
                  >
                    Two-stage Pressure Table Control
                  </Typography>
                ...
                <Box padding={5}>
                  <Grid container spacing={1} alignItems="center">
                    <Grid item xs={12} sm={7}>
                      ...
                      >
                        <ul>
                          <li>PCB Size: 530×460</li>
                          <li>Track precision: 0.5mm</li>
                          <li>Track height: 900±20mm</li>
                          <li>Transfer speed: 50~200mm/sec</li>
                          <li>Down control: pneumatic</li>
                          <li>Weight: 300kg</li>
                        </ul>
                      </Typography>
                    </Grid>
                    <Grid item xs={12} sm={4} sx={{ textAlign: "right" }}>
                      <Image
                        ...
                        src="/images/products/pti/PTI-2000L.png"
                        alt="Description of your image"
                        width={300}
                        height={400}
                        objectFit="cover"
