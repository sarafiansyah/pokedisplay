                  ...
                  <Grid container spacing={1} alignItems="center">
                    <Grid item xs={12} sm={7}>
                      ...
                      >
                        <ul>
                          ...
                          <li>User friendly</li>
                          <li>Intuitive view of test result</li>
                          <li>Intelligent optimized inspection path</li>
                          <li>Support several lcr bridge options</li>
                        </ul>
                      </Typography>
                    </Grid>
                    <Grid item xs={12} sm={4} sx={{ textAlign: "right" }}>
                      <Image
                        ...
                        src="/images/products/pti/PTI-500-FAI.jpg"
                        alt="Description of your image"
                        width={300}
                        height={400}
                        objectFit="cover"
              ...
              <Box paddingX={5}>
                <Grid container spacing={3} justifyContent="center">
                  <Box
                    ...
                    src="/images/products/pti/details/pti500-det01.png"
                    alt="Description of your image"
                    width={800}
                    height={500}
                    objectFit="cover"
