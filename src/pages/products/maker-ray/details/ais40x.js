                ...
                <Box padding={5}>
                  <Box display="flex">
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>High-precision high-speed camera lens</li>
                          <li>
                            AI algorithm one-click search for components,
                            intelligent parameter matching, and fast programming
                          </li>
                          <li>
                            Wrong material control: OCR recognition algorithm
                            detects silk screen characters
                          </li>
                          <li>
                            Inspect wrong and absent for black component on
                            black board
                          </li>
                          <li>
                            Apply pre and post reflow oven to inspect defects
                            for SMD and soldering
                          </li>
                        </ul>
                      </Typography>
                    </Box>
