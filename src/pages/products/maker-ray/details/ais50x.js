                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/maker-ray/mr-ais40x.png"
                        alt="Description of your image"
                        width={300}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>Double sided camera</li>
                          <li>Multiple optional light sources: UV+W/UV+RGBW</li>
                          <li>
                            Intelligent polygon algorithm for locking coating
                            areas
                          </li>
                          <li>
                            Inspection defects: excessive/insufficient coating,
                            splashing, foreign objects, bubbles, etc
                          </li>
                          <li>
                            Bubble numerical visualization size, thickness, and
                            width
                          </li>
                        </ul>
                      </Typography>
