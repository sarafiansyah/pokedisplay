                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/maker-ray/mr-ais30x.png"
                        alt="Description of your image"
                        width={300}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>Optional three-section track design.</li>
                          <li>High speed, high precision and low wear.</li>
                          <li>
                            Al algorithm. Quick location and easy programming.
                          </li>
                          <li>Strong inspection capability.</li>
                          <li>
                            Flexible combination with production line and
                            applicable for multiplescenarios.
                          </li>
                          <li>Traceable data and support SPC alarm.</li>
                          <li>Automatic cleaning function for lens.</li>
                        </ul>
                      </Typography>
                    </Box>
                  </Box>
                ...
                <Box sx={{ paddingBottom: 5, paddingX: 0 }}>
                  ...
                  <Box paddingX={5}>
                    <Typography variant="body1" color="initial" component="div">
                      <b>Easy programming with AI algorithm</b>
                      <br />
                      Search solder joints automatically and adjusut parameters
                      intelligently to make programming simpler and faster.
                      <br /> <br />
                      <b>Three-segment track</b>
                      <br />
                      ...
                      Reduce time of PCBA in and out to speed up inspection{" "}
                      <br /> <br />
                      <b>New version of PLC system</b> <br />
                      Strong anti-interference ability and high reliability,
                      movement speed improved greatly.
                    </Typography>
                  </Box>
                  <Box margin={3}>
                    <Typography
                        ...
                        <Box paddingTop={5}>
                          ...
                          >
                            ...
                            <Typography
                              ...
                              color="initial"
                            >
                              <b>AIS-30X HW</b> <br /> Specification Details
                            </Typography>
                            <Box marginTop={3}>
                              <Button
                                variant="contained"
                                ...
                                onClick={() =>
                                  window.open(
                                    "https://maker-rayaoi.com/product/ais30x-hw/#tab-ea477014f4705330ca8",
                                    "_blank"
                                  )
                                }
                              >
