                  ...
                  <Box display="flex">
                    ...
                    >
                      <Image
                        ...
                        src="/images/products/pa/pa-i4.png"
                        alt="Description of your image"
                        width={300}
                        height={300}
                        objectFit="cover"
                  ...
                  <Table aria-label="simple table">
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>L1,150 x D1,614 x H1,690 mm</TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell>1 Gantry × 4 Head</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Max Speed</TableCell>
                        <TableCell>1 ~ 2 sec / point</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Accuracy</TableCell>
                        <TableCell>±0.06 mm</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Part Height (Max)</TableCell>
                        <TableCell>330 × 300 mm</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Part Weight (Max)</TableCell>
                        <TableCell>80 × 80 mm</TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                </TableContainer>
