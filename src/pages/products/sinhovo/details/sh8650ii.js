                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/sinhovo/sinhovo-sh8650m.png"
                        alt="Description of your image"
                        width={300}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      ...
                      <Typography
                        ...
                        component="div"
                      >
                        <b>Optimal dual-track design</b>
                        <ul>
                          <li>
                            Maximum 690mm width, flexible dual-track solution
                          </li>
                          <li>2, 3, 4 tracks can be adjusted</li>
                          <li>
                            High-speed, high-precision configuration, suitable
                            for efficient placement
                          </li>
                          <li>Casting body, maximum space utilization</li>
                        </ul>
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  <Box>
                    ...
                    >
                      <img
                        ...
                        src="/images/products/sinhovo/details/spec-sh8650ii.jpg"
                        alt="Description of your image"
