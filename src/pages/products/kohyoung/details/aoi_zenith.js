                  ...
                  >
                    ...
                    >
                      <Typography
                        ...
                        color="initial"
                      >
                        The Industry’s Best Selling and First True 3D AOI
                        Solution
                      </Typography>
                      <Typography
                        variant="body1"
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        Using patented True 3D technology, the Zenith measures
                        true profilometric component shapes including foreign
                        materials, patterns, and solder joints with True 3D
                        capabilities to overcome inspection challenges.
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                ...
                <Box display="flex">
                  <Box>
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          Circuit boards are becoming more complex with new
                          products. An AOI machine is becoming even more crucial
                          to the electronics manufacturing lines. The industry
                          has many2D, 2.5D and pseudo-3D inspection options that
                          only compound issues with false calls and escapes. The
                          Zenith AOI Series is the only machine that delivers
                          True 3D Inspection to address solutions caused by
                          highly specular packages and shadows from adjacent
                          parts.
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          ...
                          IPC-610 standards for electronic assembly
                          acceptability requirements. It provides clear and
                          precise AOI measurements to accurately identify
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          Through Koh Young’s proprietary vison algorithms, the
                          Zenith Series can quantify the exact height of a
                          solder joint. Despite shadows or interreflection
                          challenges, the Zenith accurately inspects and
                          measures according to IPC-610 standards for electronic
                          assembly acceptability requirements.
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
                    <Accordion
