                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/kohyoung/spi/SPI_KY8030-3_Product-Image-768x809.png"
                        alt="Description of your image"
                        width={285}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      <Typography
                        ...
                        color="initial"
                      >
                        The Industry’s Fastest True 3D Solder Paste Inspection
                        System
                      </Typography>
                      <Typography
                        variant="body1"
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        The KY8030-3 is back, faster than ever using Koh Young’s
                        3D dual-inspection technology to eliminate critical
                        shadow problems while enhancing productivity and
                ...
                <Box display="flex">
                  <Box>
                    ...
                    >
                      ...
                      >
                        <Typography fontWeight="bold">
                          Unmatched Inspection Speed with Guaranteed Best
                          Accuracy
                        </Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Typography>
                          The KY8030-3 blends Koh Young’s pioneering
                          technologies with an inspection speed of 91.2 cm2/sec.
                          The combination of this system’s throughput and
                          accuracy makes the KY8030-3 suitable across a vast
                          range of applications. The latest options makes this
                          system twice as fast as its predecessor with
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          Y8030-3 dispenses solder paste automatically as an
