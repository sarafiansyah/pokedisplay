                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/kohyoung/aoi/AOI_Zenith-UHS_Product-Image-285x300.png"
                        alt="Description of your image"
                        width={285}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      <Typography
                        ...
                        color="initial"
                      >
                        The Industry’s Fastest True 3D AOI Solution
                      </Typography>
                      <Typography
                        variant="body1"
                        color="initial"
                        sx={{ marginLeft: 5 }}
                      >
                        Zenith UHS, industry’s most popular 3D AOI solution,
                        measures true profilometric component shapes, foreign
                        materials, patterns, and solder joints without
                        compromising speed and overcoming inspection challenges
                        with True 3D capabilities.
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                ...
                <Box display="flex">
                  <Box>
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          Faster than ever, the Zenith UHS measures components
                          at high volume production rates for a wide range of
                          defects without compromising inspection accuracy and
                          repeatability.
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
                    ...
                    >
                      ...
                      <AccordionDetails>
                        <Typography>
                          ...
                          AOIs. As an optional feature (9-Way Projection), the
                          Zenith UHS handles components up to 25mm tall. The
                          Zenith UHS overcomes component shadow challenges by
                          incorporating multi-projection Moiré interferometry
                          system.
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
