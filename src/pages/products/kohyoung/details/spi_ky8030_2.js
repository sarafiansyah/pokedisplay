                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/kohyoung/spi/SPI_KY8030-2_Product-Image-768x809.png"
                        alt="Description of your image"
                        width={285}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      <Typography
                        ...
                        color="initial"
                      >
                        The Industry’s Most Popular True 3D Solder Paste
                        Inspection System
                      </Typography>
                      <Typography
                        variant="body1"
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        The KY8030-2 has maintained the industry’s leading
                        position as the best-selling True 3D Solder Paste
                        Inspection System since entering the market. Combining
                        Koh Young’s patented 3D dual-projection Moiré
                        technology, it effectively eliminates critical shadow
                        and specular reflection challenges other 3D inspection
                ...
                <Box display="flex">
                  <Box>
                    ...
                    >
                      ...
                      >
                        <Typography fontWeight="bold">
                          Best-in-class Measurement Accuracy and Inspection
                          Reliability
                        </Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Typography>
                          Koh Young’s inspection systems have become the
                          industry standard. The KY8030-2 features a pioneering
                          True 3D Moiré and dual-projection by eliminating
                          shadow and specular reflection challenges without
                    ...
                    >
                      ...
                      >
                        <Typography fontWeight="bold">
                          Automated Solder Paste Dispensing: Auto-Rework
                        </Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Typography>
                          KY8030-2 dispenses solder paste automatically as an
                          optional add-on solution. The high-precision and
                          user-friendly dispensing system helps eliminate costly
                          mistakes due in large part to insufficient solder in
                          open joints, lean fillets, and weak joints. The
                          automatic dispensing option reduces operational costs,
                          improves line efficiency, and strengthens
                          profitability by eliminating board scrap and rework.
                          Once Koh Young’s SPI is configured with the
                          Auto-Rework option, it becomes more than an inspection
                          system. It becomes a true process optimizer.
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
                    <Accordion
