                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/jt/jt-rs.webp"
                        alt="Description of your image"
                        width={350}
                        height={350}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>
                            Independent air velocity controlling by section can
                            achieve flexible processing adjustment, dealing with
                            various & complicated lead-free processing easily
                          </li>
                          <li>
                            New cooling configuration to make the filtered or
                            reclaimed air return to the oven chamber, reducing
                            thermal loss and improving flux reclamation
                          </li>
                          <li>
                            Longer maintenance period for the oven chamber
                          </li>
                          <li>
                            New air management system with significant energy
                            savings, lower electric power consumption, and lower
                            carbon emissions
                          </li>
                          <li>
                            The chambers with multi-layers and thicker thermal
                            insulation to attain a lower temperature of the oven
                            surface
                          </li>
                          <li>
                            95% of the materials of the reflow oven can be
                            recycled
                          </li>
                        </ul>
                      </Typography>
