                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/jt/jt-sh3d.webp"
                        alt="Description of your image"
                        width={350}
                        height={350}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>
                            Spray Fluxer + Preheating + Soldering module,
                            integrated design, flexible configuration, and free
                            expansion
                          </li>
                          <li>
                            The point soldering module and the group soldering
                            module are freely matched and combined
                          </li>
                          <li>The most efficient selective soldering module</li>
                          <li>Sectional modular transmission structure</li>
                        </ul>
                      </Typography>
                    </Box>
                  </Box>
