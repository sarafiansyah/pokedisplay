                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/jt/jt-nitrowave.webp"
                        alt="Description of your image"
                        width={300}
                        height={300}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>
                            Nitrogen Closed-loop Control: Real-time monitoring
                            of nitrogen concentration, PID closed-loop adjust
                            nitrogen flow to achieve a stable PPM value and save
                            nitrogen consumption
                          </li>
                          <li>
                            Increase Solder Stability: Nitrogen protection
                            improves the wetting of wave infiltration and
                            enhances solder penetration rate to ensure quality
                            stability
                          </li>
                          <li>
                            Reduce Solder Defect: The tunnel-based entire
                            nitrogen wave soldering can reduce solder defects
                            and improve production efficiency with less oxygen
                            content
                          </li>
                          <li>
                            Save Cost: The closed preheating environment can
                            reduce power consumption and the production of
                            solder dross
                          </li>
                        </ul>
                      </Typography>
