                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/jt/jt-tea.webp"
                        alt="Description of your image"
                        width={350}
                        height={350}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>
                            Rail Conveyor System: The rail track undergoes a
                            hardening process to enhance reliability
                          </li>
                          <li>
                            Dual-Rail Conveyor System: The dual rail system can
                            improve productivity efficiently and save energy and
                            production costs, with a strengthened main hanging
                            bracket to avoid rail deformation
                          </li>
                          <li>
                            95% of the material of the reflow oven can be
                            recycled
                          </li>
                          <li>
                            The patented optimized structure design can minimize
                            the influence of the chamber on environmental
                            temperature
                          </li>
                          <li>
                            The automatic flux collection system is easy for
                            maintenance
                          </li>
                        </ul>
                      </Typography>
