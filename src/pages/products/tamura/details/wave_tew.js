                  ...
                  <Box display="flex">
                    <Box sx={{ display: { xs: "none", sm: "block" } }}>
                      <Image
                        ...
                        src="/images/products/tamura/wave/w_solder_1_01.jpg"
                        alt="Description of your image"
                        width={400}
                        height={270}
                        objectFit="cover"
                    ...
                    >
                      ...
                      >
                        <ul>
                          <li>
                            Compact (smaller than current air equipment),
                            maintainability has improved.
                          </li>
                          <li>
                            Energy saving with reinforced heat insulation of
                            pre-heater units.
                          </li>
                          <li>
                            Energy saving with selective pre-heater method.
                          </li>
                          <li>1.7m powerful far infraed pre-heater</li>
                          <li>
                            Titanium solder bath performs energy saving by dual
                          ...
                          <li>
                            High reliability special heat resistant resin finger
                            claws
                          </li>
                        </ul>
                      </Typography>
