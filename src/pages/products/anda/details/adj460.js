                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/anda/anda-adj460.png"
                        alt="Description of your image"
                        width={300}
                        height={200}
                        objectFit="cover"
                    ...
                    >
                      ...
                      <Typography
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        The ADJ-460 is an inline PCB buffer conveyor for high
                        capacity electronics manufacturing. This buffering or
                        linking conveyor is equipped with a robust pin chain
                        style conveyor, the pin chain conveyor holds up to
                        solvents and chemicals used in conformal coating, and
                        easily transports heavy pallets or complex PCB’s. The
                        ADJ-460 is ideal for a wide range of PCB handling
                        applications and can optimize Work-In-Progress (WIP)
                        material flow during assembly, coating, dispensing and
                        other processes.
                      </Typography>
                    </Box>
                  </Box>
            ...
            <Box sx={{ paddingBottom: 5, paddingX: 0 }}>
              ...
              <Box paddingX={5}>
                <Typography variant="body1" color="initial" component="div">
                  <ul>
                    <li>Manual conveyor width adjustment</li>
                    <li>Extruded aluminum conveyor rail</li>
                    <li>Chain transfer</li>
                    <li>Viable speed control</li>
                    <li>Board handling import/output sensor</li>
                  ...
                  <Table aria-label="simple table">
                    <TableBody>
                      ...
                      <TableRow>
                        ...
                        <TableCell width="50%">Pin Chain</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Component Height Clearance</TableCell>
                        <TableCell>± 1 oo mm (± 3.93")</TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          L800 xW 875 x H 910 mm/ H 915 mm (L 31.49" X W 34.44"
                          x H 35.82"/ H 36.02")
                        </TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell>Micro Control Unit (CU) & Button</TableCell>
                      </TableRow>
