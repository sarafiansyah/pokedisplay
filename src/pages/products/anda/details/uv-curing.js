              ...
              <Box display="flex" justifyContent="space-between">
                <Box>
                  <Typography
                    ...
                    color="#0c248c"
                  >
                    Inline Compact UV Curing Ovens
                  </Typography>
                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/anda/anda-curingOven.png"
                        alt="Description of your image"
                        width={400}
                        height={200}
                        objectFit="cover"
                    ...
                    >
                      ...
                      <Typography
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        The Anda UV curing oven series is the most powerful
                        compact inline high intensity Ultraviolet (UV) curing
                        oven system in the industry. It is capable of exceeding
                        the maximum UV intensity requirements for curing
                        virtually any UV curable product on the market today. In
                        a class of its own, the system cost is also more
                        affordable than rivaling products offered by
                        competitors.
                        <br />
                        <br />
                        The inline UV curing oven series is available in LED for
                        UVA LED curable coatings or Mercury Long-Arc for high
                        intensity, rapid curing of UV curable coatings,
                        adhesives, and inks. Closed-loop supply air ensures
                        every substrate receives the same amount of cooling UV
                        wavelength tailored to the ink, coating, or adhesive
                        formulation.
                        <br />
                        <br />
                        The inline UV curing system was designed with enhanced
                        safety protection to ensure operator protection from
                        harmful UV radiation. The systems SMEMA communication
                        and touch screen control interface integrates into new
                        or existing factory automation lines or can also be used
                        stand-alone. Pairs seamlessly with selective conformal
                        coating spraying systems and does not interfere with
                        wireless networks.
                      </Typography>
                    </Box>
                  </Box>
              ...
              <Box paddingX={5}>
                <Typography variant="body1" color="initial" component="div">
                  <ul>
                    ...
                    <li>Adjustable lamp intensity for long lamp life</li>
                    <li>
                      Advanced variable frequency power technology ensures
                      stable UV output and reduces energy consumption
                    </li>
                    <li>UV LED for UVA LED curable coatings</li>
                  </ul>
                </Typography>
              </Box>
              <Box margin={3}>
