              ...
              <Box display="flex" justifyContent="space-between">
                <Box>
                  <Typography
                    ...
                    color="#0c248c"
                  >
                    Offline Vacuum Plasma Treatment Machine
                  </Typography>
                  ...
                  >
                    <Box>
                      <Image
                        ...
                        src="/images/products/anda/anda-vpoffline.png"
                        alt="Description of your image"
                        width={300}
                        height={200}
                        objectFit="cover"
                    ...
                    >
                      ...
                      <Typography
                        ...
                        sx={{ marginLeft: 5 }}
                      >
                        VP Series are offline standalone (batch style) plasma
                        treatment units designed for immersive vacuum plasma
                        treatment and activation of a materials surface energy.
                        During this process, materials being treated are
                        completely engulfed within a plasma environment allowing
                        all surface areas of complex parts and materials to be
                        treated and activated simultaneously.
                        <br />
                        <br />
            ...
            <Box sx={{ paddingBottom: 5, paddingX: 0 }}>
              ...
              <Box paddingX={5}>
                <Typography variant="body1" color="initial" component="div">
                  <ul>
                    <li>
                      Adjustable Shelves: allow processing of a wide variety of
                      part geometrics
                    </li>
                    <li>
                      Batch Style: each unit is complete self-contained,
                      requiring minimal floor space
                    </li>
                    <li>
                      Ultra-low Temperature: system operation temperature as low
                      as 40°C
                    </li>
                    <li>
                      Omni-directional: complete immersion of the treated
                      material by anisotropic plasma
                    </li>
                    <li>
                    ...
                    <li>
                      Cleaning: remove fine dust, oil, grease and organic
                      compounds
                    </li>
                    <li>
              ...
              >
                <Box
                  ...
                  src="/images/products/anda/details/vpoffline-details-vp60.png"
                  alt="Description of your image"
                  width={800}
                  height={500}
                  objectFit="cover"
                ...
                <Box
                  ...
                  src="/images/products/anda/details/vpoffline-details-vp80.png"
                  alt="Description of your image"
                  width={800}
                  height={500}
                  objectFit="cover"
                ...
                <Box
                  ...
                  src="/images/products/anda/details/vpoffline-details-vp100.png"
                  alt="Description of your image"
                  width={800}
                  height={500}
                  objectFit="cover"
                ...
                <Box
                  ...
                  src="/images/products/anda/details/vpoffline-details-vp150.png"
                  alt="Description of your image"
                  width={800}
                  height={500}
                  objectFit="cover"
