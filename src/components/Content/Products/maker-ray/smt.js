...
function ResponsiveCarousel() {
  ...
  const handleClickOpen = (description) => {
    window.location.href = `/products/maker-ray/details/${description}`; // Redirect to the details page with the provided title
        ...
        <Box padding={3} marginTop={7}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                title="AIS203-RC"
                imageSrc="/images/products/maker-ray/mr-ais203rc.png"
                description="uncon"
              />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                title="AIS50X-C"
                imageSrc="/images/products/maker-ray/mr-ais50xc.png"
                description="uncon"
              />
            </Grid>
