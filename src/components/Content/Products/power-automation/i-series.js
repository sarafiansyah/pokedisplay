...
function ResponsiveCarousel() {
  ...
  const handleClickOpen = (description) => {
    window.location.href = `/products/power-automation/details/${description}`; // Redirect to the details page with the provided title
            ...
            <Box display="flex" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="h6" fontWeight="bold" color="#0c248c">
                  Innovative robot smart factory solution
                </Typography>
              </Box>
              <Box>
