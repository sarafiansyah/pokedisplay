...
function ResponsiveCarousel() {
  ...
  const handleClickOpen = (description) => {
    window.location.href = `/products/anda/details/${description}`; // Redirect to the details page with the provided title
      ...
      >
        <Box padding={3} marginTop={7}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                title="High Speed Series"
                imageSrc="/images/products/anda/anda-ijet7.png"
                description="ijet7"
              />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                ...
                imageSrc="/images/products/anda/anda-tsv300.png"
                description="tsv-300"
              />
            </Grid>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                title="UV-2"
                imageSrc="/images/products/anda/anda-uv2.png"
                description="uv2"
              />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <CustomCard
                title="iCure Infrared"
                imageSrc="/images/products/anda/anda-icure.png"
