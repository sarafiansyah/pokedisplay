...
const ResponsiveCarousel = () => {
  ...
  const filteredPokemons = pokeCharacters.filter((pokemon) => {
  ...
  const fetchPokemon = async () => {
    try {
      ...
      setpokeCharacters(response.data.results);
  ...
  useEffect(() => {
    console.log("generated", pokeCharacters); // Logs `pokeCharacters` when it changes
  }, [pokeCharacters]);
